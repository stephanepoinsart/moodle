...
$string['confignoreplydisplayname'] = 'When moodle sends email associated to the no-reply address, the recipient email client will usually display this name as the sender. If empty, moodle will default to the user real name when possible (i.e. forum poster), convenient to know who wrote the message without opening it, but can cause lost messages if the recipient confuse the no-reply address for the real user address.';
...
$string['noreplydisplayname'] = 'No-reply display name';
