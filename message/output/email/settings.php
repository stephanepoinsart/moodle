...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configtext('noreplydisplayname', get_string('noreplydisplayname', 'message_email'), get_string('confignoreplydisplayname', 'message_email'), '', PARAM_NOTAGS));
